		...
		["PixelPerfect"] = {
			...
			["captured_spells"] = {
				...
				[2580] = {
					["event"] = "SPELL_AURA_APPLIED",
					["type"] = "BUFF",
					["source"] = "Penguintanks-Bonechewer",
					["npcID"] = 0,
				},
				[231895] = {
					["type"] = "BUFF",
