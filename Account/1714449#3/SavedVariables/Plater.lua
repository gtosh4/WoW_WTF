		...
		["PixelPerfect"] = {
			...
			["captured_spells"] = {
				...
				[328136] = {
					["event"] = "SPELL_AURA_APPLIED",
					["type"] = "BUFF",
					["source"] = "Kontrolling-Tichondrius",
					["npcID"] = 0,
				},
				[279033] = {
					["type"] = "BUFF",
