	...
	["profiles"] = {
		...
		["PixelPerfect"] = {
			...
			["captured_spells"] = {
				...
				[269571] = {
					["type"] = "BUFF",
					["source"] = "Menhaden-BleedingHollow",
					["encounterID"] = 2344,
					["event"] = "SPELL_AURA_APPLIED",
					["npcID"] = 0,
				},
