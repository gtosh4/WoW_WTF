		...
		["PixelPerfect"] = {
			...
			["captured_spells"] = {
				...
				[1459] = {
					["event"] = "SPELL_AURA_APPLIED",
					["type"] = "BUFF",
					["source"] = "Tigglesquirt-BleedingHollow",
					["npcID"] = 0,
				},
				[256699] = {
					["event"] = "SPELL_CAST_SUCCESS",
