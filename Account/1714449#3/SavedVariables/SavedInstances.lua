...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Toshaman - Area 52"] = {
			["lastbossyell"] = "General Draven: Heroic",
			["isResting"] = true,
			["Emissary"] = {
				[6] = {
					["unlocked"] = true,
