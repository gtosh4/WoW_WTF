...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Tosh - Kil'jaeden"] = {
			["lastbossyell"] = "King Mechagon: Mythic",
			["isResting"] = true,
			["Emissary"] = {
				[6] = {
					["unlocked"] = true,
			...
			["MythicKey"] = {
				["mapID"] = 246,
				["name"] = "Tol Dagor",
				["link"] = "|cffa335ee|Hkeystone:158923:246:10:9:6:4:119|h[Keystone: Tol Dagor (10)]|h|r",
				["color"] = "ffa335ee",
				["level"] = 10,
				["ResetTime"] = 1568732399,
			},
			["PlayedTotal"] = 1402483,
			["lastbossyelltime"] = 1568338066,
			["MaxXP"] = 893550,
			["oRace"] = "BloodElf",
			["LastSeen"] = 1568431894,
			["DailyResetTime"] = 1568559599,
		...
		["Operation: Mechagon"] = {
			...
			["Tosh - Kil'jaeden"] = {
				[23] = {
					["Expires"] = 1568732398,
					["Extended"] = false,
					["Link"] = "|cffff8000|Hinstancelock:Player-9-0B60C7FF:2097:23:255|h[Operation: Mechagon]|h|r",
					["ID"] = 376949560,
					["Locked"] = true,
				},
			},
