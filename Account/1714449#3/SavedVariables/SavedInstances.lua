...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Toshmonk - Kil'jaeden"] = {
			["lastbossyell"] = "Corspecutter Moroc",
			["isResting"] = true,
			["Emissary"] = {
				[6] = {
					["unlocked"] = true,
