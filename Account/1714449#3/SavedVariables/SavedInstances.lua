...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Toshmonk - Kil'jaeden"] = {
			["lastbossyell"] = "Castellan Niklaus: Heroic",
			["isResting"] = true,
			["Emissary"] = {
				[6] = {
					["unlocked"] = true,
			...
			["PlayedTotal"] = 3079436,
			["lastbossyelltime"] = 1608271904,
			["Money"] = 2002191502,
			["Zone"] = "Bastion",
			["Skills"] = {
			},
			["lastboss"] = "Sun King's Salvation: Heroic",
			["MythicKeyBest"] = {
				["ResetTime"] = 1608649199,
				["rewardWaiting"] = true,
			},
