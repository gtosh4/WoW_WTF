...
BugGrabberDB = {
	...
	["errors"] = {
		...
		{
			["message"] = "[ADDON_ACTION_BLOCKED] AddOn 'ExRT' tried to call the protected function 'ExRTConsumables:SetWidth()'.",
			["time"] = "2021/01/26 21:07:51",
			["locals"] = "Skipped (In Encounter)",
			["stack"] = "[string \"@Interface\\AddOns\\!BugGrabber\\BugGrabber.lua\"]:519: in function <Interface\\AddOns\\!BugGrabber\\BugGrabber.lua:519>\n[string \"=[C]\"]: in function `SetWidth'\n[string \"@Interface\\AddOns\\ExRT\\RaidCheck.lua\"]:2650: in function `Update'\n[string \"@Interface\\AddOns\\ExRT\\RaidCheck.lua\"]:2842: in function <Interface\\AddOns\\ExRT\\RaidCheck.lua:2831>",
			["session"] = 895,
			["counter"] = 1,
		}, -- [2]
	},
