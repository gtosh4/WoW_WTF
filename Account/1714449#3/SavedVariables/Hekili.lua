				...
				["Shadow"] = {
					...
					["lists"] = {
						["single"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( buff.voidform.stack > 20 & insanity <= 50 ) || buff.voidform.stack > ( 25 + 5 * buff.bloodlust.up ) || ( current_insanity_drain * gcd.max * 3 ) > insanity",
							...
							}, -- [13]
							{
								...
								["criteria"] = "equipped.pocketsized_computation_device & ( buff.voidform.up & buff.chorus_of_insanity.stack > 20 ) || azerite.chorus_of_insanity.rank = 0",
							}, -- [14]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "time_to_die < 3 || cooldown.shadow_word_death.charges = 2 || ( cooldown.shadow_word_death.charges = 1 & cooldown.shadow_word_death.remains < gcd.max )",
