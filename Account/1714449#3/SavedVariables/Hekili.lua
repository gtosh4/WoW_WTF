				...
				["Brewmaster"] = {
					...
					["lists"] = {
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "health.pct < 5 * health_sphere.count || ( healing_sphere.count >= 3 & health.pct < 50 )",
								["action"] = "expel_harm",
							}, -- [17]
							{
								["enabled"] = true,
