		...
		["PixelPerfect"] = {
			...
			["captured_spells"] = {
				...
				[203975] = {
					["event"] = "SPELL_AURA_APPLIED",
					["type"] = "BUFF",
					["source"] = "Bullowny-BleedingHollow",
					["npcID"] = 0,
				},
				[256960] = {
					["source"] = "Reanimated Honor Guard",
