...
WeakAurasSaved = {
	...
	["displays"] = {
		["nocircle_leaf_nofil"] = {
			...
			["anchorPoint"] = "CENTER",
			["cooldownSwipe"] = true,
			["url"] = "https://wago.io/hVLym_eLv/27",
			["icon"] = true,
			["triggers"] = {
				{
					["trigger"] = {
