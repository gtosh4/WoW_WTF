...
BugGrabberDB = {
	...
	["errors"] = {
		...
		{
			["message"] = "[ADDON_ACTION_BLOCKED] AddOn 'Auctionator' tried to call the protected function 'PetActionButton2:Hide()'.",
			["time"] = "2019/03/23 23:34:20",
			["locals"] = "InCombatSkipped",
			["stack"] = "Interface\\AddOns\\!BugGrabber\\BugGrabber.lua:519: in function <Interface\\AddOns\\!BugGrabber\\BugGrabber.lua:519>\n[C]: in function `Hide'\nInterface\\FrameXML\\PetActionBarFrame.lua:202: in function `PetActionBar_Update'\nInterface\\FrameXML\\PetActionBarFrame.lua:90: in function <Interface\\FrameXML\\PetActionBarFrame.lua:78>\n[C]: in function `TurnOrActionStop'\n[string \"TURNORACTION\"]:4: in function <[string \"TURNORACTION\"]:1>",
			["session"] = 602,
			["counter"] = 1,
		}, -- [4]
		{
