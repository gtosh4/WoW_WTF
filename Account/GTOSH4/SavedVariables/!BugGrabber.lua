...
BugGrabberDB = {
	...
	["errors"] = {
		...
		}, -- [12]
		{
			...
			["time"] = "2019/01/16 01:28:41",
			["locals"] = "InCombatSkipped",
			["stack"] = "[C]: in function `UnitClass'\nInterface\\AddOns\\WeakAuras\\AuraEnvironment.lua:45: in function `WA_ClassColorName'\n[string \"--[[ Error in 'Poison Barrage TSU' ]] retur...\"]:25: in function <[string \"--[[ Error in 'Poison Barrage TSU' ]] retur...\"]:7>",
			["session"] = 1927,
			["counter"] = 1,
		}, -- [13]
		{
