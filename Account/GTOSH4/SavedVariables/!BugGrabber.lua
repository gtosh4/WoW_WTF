...
BugGrabberDB = {
	...
	["errors"] = {
		...
		{
			["message"] = "Couldn't open Interface\\AddOns\\LittleWigs\\TBC\\OldHillsbradFoothills\\modules.xml",
			["session"] = 1821,
			["time"] = "2020/02/05 10:10:25",
			["counter"] = 4,
		}, -- [2]
		{
			["message"] = "...\\AddOns\\AddOnSkins\\Skins\\Blizzard\\Retail\\Talents.lua:131: attempt to index field 'knownSelection' (a nil value)",
			["time"] = "2020/02/05 10:39:02",
