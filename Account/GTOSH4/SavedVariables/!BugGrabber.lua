	...
	["errors"] = {
		{
			...
			["time"] = "2019/08/25 14:55:32",
			["stack"] = "[C]: in function `xpcall'\nInterface\\AddOns\\WeakAuras\\WeakAuras-2.14.0.lua:5700: in function `RunCustomTextFunc'\n...nterface\\AddOns\\WeakAuras\\SubRegionTypes\\SubText.lua:243: in function `FrameTick'\n...ace\\AddOns\\WeakAuras\\RegionTypes\\RegionPrototype.lua:541: in function <...ace\\AddOns\\WeakAuras\\RegionTypes\\RegionPrototype.lua:528>",
			["session"] = 1204,
			["counter"] = 77,
		}, -- [1]
		{
			["message"] = "Invalid quest item in SetQuestLogItem(\"type\", index [, questID])",
			["time"] = "2019/08/26 22:46:47",
