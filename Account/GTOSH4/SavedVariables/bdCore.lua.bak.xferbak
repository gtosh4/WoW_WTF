	...
	["persistent"] = {
		["bdAddons"] = {
			...
			["gmotd"] = {
				...
				["Mythic Azshara + Heroic Ny'alotha wed @ 7pm CST. Main Raid fri/sat  LOOK UP DREST / RADEN "] = true,
				...
				["Heroic Ny'alotha wed @ 7pm CST. Main Raid fri/sat  watch carapace"] = true,
				...
				["ALT H EP @7pm CST(wed). Main Raid Fri/Sat 830pm-1230am cst. "] = true,
				...
				["Main Raid fri/sat be prepared for ilgy/carapace. Just play better"] = true,
				...
				["Heroic LAST 2 in 15mins please help if youre around. Main Raid Fri/Sat Look up vexiona"] = true,
				["(ALT)H EP WED @ 7pm CST. Make sure youre ready for new raid.  Main Raid Fri/Sat 830pm-1230am cst. "] = true,
				["heroic ny'alotha wed @ 7pm cst. mythic nzoth fri/sat 830pm cst "] = true,
