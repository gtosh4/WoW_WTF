...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Toshpriest - Area 52"] = {
			["lastbossyell"] = "Blistering Ash Ghoul",
			["isResting"] = true,
			["Emissary"] = {
				[6] = {
					["unlocked"] = true,
