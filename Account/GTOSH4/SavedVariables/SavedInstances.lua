...
SavedInstancesDB = {
	...
	["Toons"] = {
		["Toshlongboyr - Eldre'Thalas"] = {
			["lastbossyell"] = "Magni Bronzebeard",
			["isResting"] = true,
			["Emissary"] = {
				[6] = {
					["unlocked"] = true,
