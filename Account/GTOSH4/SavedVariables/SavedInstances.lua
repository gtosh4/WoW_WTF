...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Toshpal - Area 52"] = {
			["lastbossyell"] = "Bluearruwu: Mythic",
			["isResting"] = true,
			["Emissary"] = {
				[6] = {
					["unlocked"] = true,
