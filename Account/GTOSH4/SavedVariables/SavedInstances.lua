...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Toshpriest - Area 52"] = {
			["lastbossyell"] = "General Draven: Mythic",
			["isResting"] = true,
			["Emissary"] = {
				[6] = {
					["unlocked"] = true,
