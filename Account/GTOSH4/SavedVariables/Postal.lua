...
Postal3DB = {
	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				...
				"Toshtrial|Blood Furnace|Horde|100|MAGE", -- [3]
				"Toshtrial|The Forgotten Coast|Horde|100|PRIEST", -- [4]
				"Toshtrial|Ursin|Horde|100|MAGE", -- [5]
				"Tosh|Kil'jaeden|Horde|120|PRIEST", -- [6]
				"Tosku|Kil'jaeden|Horde|110|DEMONHUNTER", -- [7]
				"Yorman|Kil'jaeden|Horde|120|DRUID", -- [8]
				"Yuumi|Kil'jaeden|Horde|120|MONK", -- [9]
				"Zaemme|Kil'jaeden|Horde|120|PALADIN", -- [10]
	...
	["profiles"] = {
		["Zaemme - Kil'jaeden"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Crippled-Kil'jaeden|Kil'jaeden|Horde", -- [5]
					"Nv|Kil'jaeden|Horde", -- [6]
		...
		["Yorman - Kil'jaeden"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Yuumi|Kil'jaeden|Horde", -- [3]
					"Yukio|Kil'jaeden|Horde", -- [4]
					"Yellowy|Kil'jaeden|Horde", -- [5]
					"Nv|Kil'jaeden|Horde", -- [6]
					"Pride|Kil'jaeden|Horde", -- [7]
		...
		["Yuumi - Kil'jaeden"] = {
			["BlackBook"] = {
				["recent"] = {
					"Pass|Kil'jaeden|Horde", -- [1]
					"Tosh|Kil'jaeden|Horde", -- [2]
					"Yellowy|Kil'jaeden|Horde", -- [3]
					"Yorman|Kil'jaeden|Horde", -- [4]
					"Zaemme|Kil'jaeden|Horde", -- [5]
					"Tosku|Kil'jaeden|Horde", -- [6]
				},
			},
		},
		["Zallie - Frostwolf"] = {
