	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				...
				"Toshwar|Kil'jaeden|Horde|20|WARRIOR", -- [10]
				"Tosh|Frostwolf|Horde|100|ROGUE", -- [11]
				"Tosh|Kil'jaeden|Horde|120|PRIEST", -- [12]
				"Tosku|Kil'jaeden|Horde|110|DEMONHUNTER", -- [13]
				"Yorman|Kil'jaeden|Horde|120|DRUID", -- [14]
				"Zallie|Frostwolf|Horde|90|PRIEST", -- [15]
			},
		},
	},
	["profiles"] = {
		["Toshpal - Kil'jaeden"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Tehkz|Kil'jaeden|Horde", -- [4]
					"Sci|Kil'jaeden|Horde", -- [5]
					"Choplo|Kil'jaeden|Horde", -- [6]
					"Simbbaa|Kil'jaeden|Horde", -- [7]
					"Hyperr|Kil'jaeden|Horde", -- [8]
					"Lyuneria|Kil'jaeden|Horde", -- [9]
					"Andruww|Kil'jaeden|Horde", -- [10]
					"Warlockmania|Kil'jaeden|Horde", -- [11]
					"Sploshey|Kil'jaeden|Horde", -- [12]
					"Turkeyone|Kil'jaeden|Horde", -- [13]
					"Yukio|Kil'jaeden|Horde", -- [14]
					"Delpi|Kil'jaeden|Horde", -- [15]
					"Arnbjørn|Kil'jaeden|Horde", -- [16]
					"Thunderrz|Kil'jaeden|Horde", -- [17]
					"Pluie|Kil'jaeden|Horde", -- [18]
					"Oxclamatiøn|Kil'jaeden|Horde", -- [19]
					"Peace|Kil'jaeden|Horde", -- [20]
				},
			},
		},
