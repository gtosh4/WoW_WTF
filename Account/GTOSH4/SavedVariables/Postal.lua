...
Postal3DB = {
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				...
				"Tosh|Kil'jaeden|Horde|120|PRIEST", -- [2]
				"Yorman|Kil'jaeden|Horde|120|DRUID", -- [3]
				"Yuumi|Kil'jaeden|Horde|120|MONK", -- [4]
	...
	["profiles"] = {
		...
		["Toshaman - Kil'jaeden"] = {
			["BlackBook"] = {
				["recent"] = {
					"Yukio|Kil'jaeden|Horde", -- [1]
					"Tosh|Kil'jaeden|Horde", -- [2]
					"Zaemme|Kil'jaeden|Horde", -- [3]
					"Wraithbrand|Kil'jaeden|Horde", -- [4]
					"Nv-Kil'jaeden|Kil'jaeden|Horde", -- [5]
					"Yuumi|Kil'jaeden|Horde", -- [6]
				},
			},
		},
		["Yuumi - Kil'jaeden"] = {
