...
EncounterDetailsDB = {
	["emotes"] = {
		...
		}, -- [1]
		{
			...
			{
				267.96399999992, -- [1]
				"|TInterface\\Icons\\INV_STAFF_53:20|t|cFFFF0000%s|r marks |cFFFF0000Moonblight|r for a massive |cFFFF0000|Hspell:288380|h[Siegebreaker Blast]|h|r, move away!", -- [2]
				"Lady Jaina Proudmoore", -- [3]
				1, -- [4]
			}, -- [31]
			{
